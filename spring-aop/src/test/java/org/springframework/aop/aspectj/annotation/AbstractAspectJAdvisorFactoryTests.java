...
public abstract class AbstractAspectJAdvisorFactoryTests {
	...
	public void testPerTargetAspect() throws SecurityException, NoSuchMethodException {
		...
		ReflectiveAspectJAdvisorFactory.SyntheticInstantiationAdvisor sia = (ReflectiveAspectJAdvisorFactory.SyntheticInstantiationAdvisor) advised
				.getAdvisors()[1];
		assertTrue(sia.getPointcut().getMethodMatcher()
		...
		assertTrue(maaif.getAspectMetadata().getPerClausePointcut().getMethodMatcher()
				.matches(TestBean.class.getMethod("getSpouse"), null));
	...
	public void testPerThisAspect() throws SecurityException, NoSuchMethodException {
		...
		assertTrue(imapa.getDeclaredPointcut().getMethodMatcher()
	...
	public void testIntroductionBasedOnAnnotationMatch_SPR5307() {
		...
		List<Advisor> advisors = getFixture()
				.getAdvisors(new SingletonMetadataAwareAspectInstanceFactory(
...
class MakeAnnotatedTypeModifiable extends AbstractMakeModifiable {
	...
	@DeclareParents(value = "(@org.springframework.aop.aspectj.annotation.Measured *)", defaultImpl = DefaultLockable.class)
